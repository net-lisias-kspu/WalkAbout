...
These locations are not adjacent to doors around the KSC, so they are not included in the core set of .loc files. However, they do represents locations that a user may find useful for gameplay.
