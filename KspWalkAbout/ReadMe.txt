...
Perpetual Motion:
	...
	The run key (left-shift) will act as a toggle, switching your kerbal's movement from walking and running.
	Time acceleration is limited to physics time-warp only (1x, 2x, 3x, 4x).
	Pressing the activation again will take you out of Perpetual Motion mode.
